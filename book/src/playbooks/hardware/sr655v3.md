...
The Lenovo SR655 V3 (7D9E variant) is a single socket AMD server used as the CPU/CPL, Forge block storage (FBSTR)
and site controller nodes for the Azure phase 2b sites:

* AZ41 - Toronto Canada (CNC)
* AZ51,AZ52 - Osaka Japan (JPW)
* AZ61 - Frankfurt Germany (GWC)
...
There are two different loadouts for the SR 655 V3 depending on the use-case:

| | | | | | |
|---|---|---|---|---|---|
| Node Type | Vendor | Model | Component | Description | Quantity |
| FBSTR | Lenovo | ThinkSystem SR655 V3 OVX | | |  |
| example: [J701MTHZ](https://api-az61.frg.nvidia.com/admin/machine/fm100ht3op5aqeod23m0hmomee8lsbfqae0qo43mvp05ja0fae2k3hqvp6g) | | | DPU | Bluefield 3 | 1 |
| | | | CPU | AMD 9334 @ 3.9GHz | 1 |
| | | | Memory | 384GB (32GB Sticks) | 8 |
| | | | Disks (boot) | 960GB M2 NVMe SSD | 1 |
| | | | Disks (data) | 7.68TB NVMe SSD | 8 |
| CPU | Lenovo | ThinkSystem SR655 V3 OVX | | | |
| example: [J701MTHH](https://api-az61.frg.nvidia.com/admin/machine/fm100httcp488qr9dvuh06cu2che8ov4q7snk74oilqd49oqt7gu0o7du70) | | | DPU | Bluefield 3 | 1 |
| | | | CPU | AMD 9334 @ 3.9GHz | 1 |
| | | | Memory | 384GB (32GB Sticks) | 8 |
| | | | Disks (boot) | 960GB M2 NVMe SSD | 1 |
